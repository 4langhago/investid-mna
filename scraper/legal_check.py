...
SECTOR_RULES = [
    ...
    (r"restoran|rumah makan|resto|cafe|café|kedai kopi|식당|음식점|카페|커피",
     ...
     "요식업은 BKPM 규정 2021-4 제12조상 같은 시·군 안의 매장 투자를 합산할 수 있었다"
     "(2025-5 이후 유지 여부는 미확인 - OSS·BKPM 에 확인)."),
    (r"laundry|binatu|세탁소|런드리",
     "세탁업(KBLI 96200)은 Perpres 49/2021 부속서 II 상 UMKM·협동조합 유보 업종이다.",
     "외국인·PT PMA 명의 인수 경로가 없다. 현지인 명의로 인수하는 구조는 투자법상 무효."),
...
OPERATING_STEPS = [
    ("① 법인(PT PMA) 설립",
     ...
     "대행 비용 Rp 2~4천만. 납입자본 Rp 25억(BKPM 규정 2025-5)은 납입 후 12개월간 "
     "설비·운영비 외 인출 불가, 투자계획은 KBLI·사업장당 Rp 100억 초과가 별도로 필요하다."),
    ("② 체류·취업 자격",
